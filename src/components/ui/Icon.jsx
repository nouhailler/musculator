...
import {
  ...
  House, HouseLine, Info, Lightning, LineSegment, ListChecks, LockKey,
  MagnifyingGlass, Medal,
...
const REGISTRY = {
  ...
  info: Info, lightning: Lightning, 'line-segment': LineSegment,
  'list-checks': ListChecks, 'lock-key': LockKey,
