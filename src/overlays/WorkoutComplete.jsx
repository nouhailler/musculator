...
export default function WorkoutComplete() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0, zIndex: 59, background: 'radial-gradient(120% 90% at 50% 0%,var(--color-accent-900),var(--color-bg) 60%)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '40px 24px' }}>
      ...
      <h2 style={{ margin: '0 0 4px', textAlign: 'center' }}>Séance terminée !</h2>
      <div style={{ fontSize: 13, color: 'var(--color-neutral-300)', textAlign: 'center', marginBottom: 24 }}>Bravo — tu construis du muscle 💪</div>
      <div style={{ display: 'flex', gap: 10, width: '100%', maxWidth: 320, marginBottom: 14 }}>
        ...
        <div className="stat-box" style={{ padding: '13px 4px' }}><div className="stat-value" style={{ fontSize: 20 }}>{c.exos}</div><div className="stat-label">exercices</div></div>
