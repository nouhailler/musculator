...
const TAB_SCREENS = { home: Home, programs: Programs, library: Library, journal: Journal, progress: Progress };
const OVERLAYS = { exercise: ExerciseDetail, program: ProgramDetail, bodymap: BodyMap, profile: Profile, builder: Builder };
